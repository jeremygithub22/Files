...
{
    public partial class frmFRreport : Form
    {
        public frmFRreport()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (cboSearchby.Text == "Employee ID")
                {
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Employee does not exist.", "Flag Retreat Report", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
        ...
        void perDisplay()
        {
            try
            {
                ...
                da.Fill(dsReports.tblretreat);
                Connection.Conn.Close();
                if (dsReports.tblretreat.Count != 0)
                {
                    LoadSet();
        ...
        {
            if (dsReports.tblretreat.Rows.Count != 0)
            {
                frmAddFR.rv = rvDisplay;
                frmAddFR fr = new frmAddFR();
                fr.ShowDialog();
            }
        }
    }
